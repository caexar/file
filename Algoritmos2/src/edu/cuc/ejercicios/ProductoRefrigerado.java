...
final public class ProductoRefrigerado extends Producto{
    protected int codigoDeSupervisionAlimentaria;
    protected Calendar fechaDeEnvasado;
    protected float temperaturaRecomendada;
    protected String paisOrigen;

    public ProductoRefrigerado(int diaEnvasado, int mesEnvasado, int añoEnvasado,
    ...
    public String toString() {
        return "ProductoRefrigerado{" + "fechaCaducidad: " + this.verFechaCaducidad() 
                +", fechaDeEnvasado: " + this.verFechaDeEnvasado() 
                + ", codigoDeSupervisionAlimentaria: " + codigoDeSupervisionAlimentaria 
